...
var ClassRepository = function ()
{
    ...
    var _getDefaultFields = function(){
        var defaultFields = [
            ...
            {"Fecha_Reserva":[{fieldType: "DATE", requiredField: false}]},
            {"Anos_Reserva":[{fieldType: "INT", requiredField: false}]},
            {"Funcionario_Reserva":[{fieldType: "TEXT", requiredField: false}]},
...
//            {"Fundamento_Legal":[{fieldType: "TEXT", requiredField: false}]},
            ...
            {"Concentracion":[{fieldType: "DATE", requiredField: false}]},
